    ...
    <table>
        ...
        <tbody>      
            <?php
                ...
                $user_del = $_POST['b1'];
                $statement = "delete from tb1_board where board_list = $user_del";
                mysqli_query($conn, $statement);
                
                $statement2 = "select * from tb1_board";
                $res = mysqli_query($conn, $statement2);
